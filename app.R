...
translations <- list(
  en = list(
    ...
    "QualiSigma" = "QualiSigma",
    "Select variables for histogram:" = "Select variables for histogram:",
    "Frequency" = "Frequency",
    "Total number of observations:" = "Total number of observations:",
    "No variables selected." = "No variables selected.",
    "Selected variables do not exist in the dataset." = "Selected variables do not exist in the dataset.",
    "Please select at least one numeric variable." = "Please select at least one numeric variable.",
    "No numeric data to display." = "No numeric data to display.",
    "No valid numeric data for scatter plot." = "No valid numeric data for scatter plot.",
    "The selected variable does not exist in the dataset." = "The selected variable does not exist in the dataset.",
    "Not enough valid numeric data for control chart." = "Not enough valid numeric data for control chart.",
    "At least 5 numeric values are required for the Lilliefors test." = "At least 5 numeric values are required for the Lilliefors test.",
    "At least 3 numeric values are required for the Shapiro-Wilk test." = "At least 3 numeric values are required for the Shapiro-Wilk test.",
    "Shapiro-Wilk test supports a maximum of 5000 values." = "Shapiro-Wilk test supports a maximum of 5000 values.",
    "The amount of data must be greater than or equal to the size of the subgroup." = "The amount of data must be greater than or equal to the size of the subgroup.",
    "Not enough numeric data in the selected column for the chosen subgroup size." = "Not enough numeric data in the selected column for the chosen subgroup size.",
    "More than one subgroup is required to perform the analysis." = "More than one subgroup is required to perform the analysis.",
    "The lower limit (LIE) must be less than the upper limit (LES)." = "The lower limit (LIE) must be less than the upper limit (LES).",
    "Please, define the target value." = "Please, define the target value.",
    "The target value must be between the lower limit (LIE) and the upper limit (LES)." = "The target value must be between the lower limit (LIE) and the upper limit (LES).",
    "Not enough data for capability analysis." = "Not enough data for capability analysis.",
    "Download Histogram" = "Download Histogram",
    "Download QQ Plot" = "Download QQ Plot",
    "Download Scatter Plot" = "Download Scatter Plot",
    "Download Pareto Chart" = "Download Pareto Chart",
    "Download X-bar Chart" = "Download X-bar Chart",
    "Download Control Chart" = "Download Control Chart",
    "Download S Chart" = "Download S Chart",
    "Download R Chart" = "Download R Chart",
    "Language" = "Language"
  ),
  it = list(
    Month = "Mese",
    ...
    "QualiSigma" = "QualiSigma",
    "Select variables for histogram:" = "Seleziona variabili per l'istogramma:",
    "Frequency" = "Frequenza",
    "Total number of observations:" = "Numero totale di osservazioni:",
    "No variables selected." = "Nessuna variabile selezionata.",
    "Selected variables do not exist in the dataset." = "Le variabili selezionate non esistono nel dataset.",
    "Please select at least one numeric variable." = "Seleziona almeno una variabile numerica.",
    "No numeric data to display." = "Nessun dato numerico da visualizzare.",
    "No valid numeric data for scatter plot." = "Nessun dato numerico valido per il grafico di dispersione.",
    "The selected variable does not exist in the dataset." = "La variabile selezionata non esiste nel dataset.",
    "Not enough valid numeric data for control chart." = "Dati numerici non sufficienti per il diagramma di controllo.",
    "At least 5 numeric values are required for the Lilliefors test." = "Sono necessari almeno 5 valori numerici per il test di Lilliefors.",
    "At least 3 numeric values are required for the Shapiro-Wilk test." = "Sono necessari almeno 3 valori numerici per il test di Shapiro-Wilk.",
    "Shapiro-Wilk test supports a maximum of 5000 values." = "Il test di Shapiro-Wilk supporta un massimo di 5000 valori.",
    "The amount of data must be greater than or equal to the size of the subgroup." = "La quantità di dati deve essere maggiore o uguale alla dimensione del sottogruppo.",
    "Not enough numeric data in the selected column for the chosen subgroup size." = "Dati numerici insufficienti nella colonna selezionata per la dimensione del sottogruppo scelta.",
    "More than one subgroup is required to perform the analysis." = "Sono necessari più di un sottogruppo per eseguire l'analisi.",
    "The lower limit (LIE) must be less than the upper limit (LES)." = "Il limite inferiore (LIE) deve essere inferiore al limite superiore (LES).",
    "Please, define the target value." = "Definire il valore target.",
    "The target value must be between the lower limit (LIE) and the upper limit (LES)." = "Il valore target deve essere compreso tra il limite inferiore (LIE) e il limite superiore (LES).",
    "Not enough data for capability analysis." = "Dati insufficienti per l'analisi di capacità.",
    "Download Histogram" = "Scarica Istogramma",
    "Download QQ Plot" = "Scarica QQ Plot",
    "Download Scatter Plot" = "Scarica Grafico di Dispersione",
    "Download Pareto Chart" = "Scarica Diagramma di Pareto",
    "Download X-bar Chart" = "Scarica Diagramma X-bar",
    "Download Control Chart" = "Scarica Diagramma di Controllo",
    "Language" = "Lingua"
  ),
  pt = list(
    search = "Pesquisar:",
    ...
    "QualiSigma" = "QualiSigma",
    "Select variables for histogram:" = "Selecionar variáveis para o histograma:",
    "Frequency" = "Frequência",
    "Total number of observations:" = "Número total de observações:",
    "No variables selected." = "Nenhuma variável selecionada.",
    "Selected variables do not exist in the dataset." = "As variáveis selecionadas não existem no conjunto de dados.",
    "Please select at least one numeric variable." = "Por favor, selecione pelo menos uma variável numérica.",
    "No numeric data to display." = "Nenhum dado numérico para exibir.",
    "No valid numeric data for scatter plot." = "Nenhum dado numérico válido para o gráfico de dispersão.",
    "The selected variable does not exist in the dataset." = "A variável selecionada não existe no conjunto de dados.",
    "Not enough valid numeric data for control chart." = "Dados numéricos insuficientes para o gráfico de controle.",
    "At least 5 numeric values are required for the Lilliefors test." = "São necessários pelo menos 5 valores numéricos para o teste de Lilliefors.",
    "At least 3 numeric values are required for the Shapiro-Wilk test." = "São necessários pelo menos 3 valores numéricos para o teste de Shapiro-Wilk.",
    "Shapiro-Wilk test supports a maximum of 5000 values." = "O teste de Shapiro-Wilk suporta no máximo 5000 valores.",
    "The amount of data must be greater than or equal to the size of the subgroup." = "A quantidade de dados deve ser maior ou igual ao tamanho do subgrupo.",
    "Not enough numeric data in the selected column for the chosen subgroup size." = "Dados numéricos insuficientes na coluna selecionada para o tamanho do subgrupo escolhido.",
    "More than one subgroup is required to perform the analysis." = "É necessário mais de um subgrupo para realizar a análise.",
    "The lower limit (LIE) must be less than the upper limit (LES)." = "O limite inferior (LIE) deve ser menor que o limite superior (LES).",
    "Please, define the target value." = "Por favor, defina o valor alvo.",
    "The target value must be between the lower limit (LIE) and the upper limit (LES)." = "O valor alvo deve estar entre o limite inferior (LIE) e o limite superior (LES).",
    "Not enough data for capability analysis." = "Dados insuficientes para análise de capacidade.",
    "Download Histogram" = "Baixar Histograma",
    "Download QQ Plot" = "Baixar Gráfico QQ",
    "Download Scatter Plot" = "Baixar Gráfico de Dispersão",
    "Download Pareto Chart" = "Baixar Gráfico de Pareto",
    "Download X-bar Chart" = "Baixar Gráfico X-barra",
    "Download Control Chart" = "Baixar Gráfico de Controle",
    "Language" = "Idioma"
  )
)
        ...
        mainPanel(
          tabsetPanel(id = "tabs", selected = "data",
                      ...
                      tabPanel(tr("hist_tab", lang), value = "histogram",
                               ...
                               downloadButton("download_hist",tr ("Download Histogram", lang)),
                               plotOutput("histPlot"),
                               downloadButton("download_qq", tr("Download QQ Plot", lang)),
                               plotOutput("qqPlot"),
                      ...
                      tabPanel(tr("scatter_tab", lang), value = "scatter",
                               ...
                               downloadButton("download_scatter", tr ("Download Scatter Plot", lang)),
                      ...
                      tabPanel(tr("pareto_tab", lang), value = "pareto",
                               ...
                               downloadButton("download_pareto", tr("Download Pareto Chart", lang)),
                      ...
                      tabPanel(tr("control_tab", lang), value = "control",
                               ...
                               br(),
                               downloadButton("download_xbar",tr("Download X-bar Chart", lang)),
                               plotOutput("xbar_chart"),
                               br(),
                               plotOutput("control_chart"),
                               downloadButton("download_s_chart", tr("Download S Chart", lang)),
                               downloadButton("download_r_chart", tr("Download R Chart", lang)),
                      ),
...
output$download_qq <- downloadHandler(
  ...
  plot_control_chart <- function(df, input, lang, type = "xbar") {
    ...
    qcc_xbar <- generate_control_chart(subgroups,type)
    plot(qcc_xbar)
  }
  #download x-bar
